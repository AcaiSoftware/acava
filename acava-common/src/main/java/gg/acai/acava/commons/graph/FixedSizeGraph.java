...
/**
 * @author Clouke
 * @since 22.02.2023 22:16
 * © Acava - All Rights Reserved
 */
@Use("Use Graph#newBuilder() to create a new graph")
public class FixedSizeGraph<N extends Number> extends AbstractGraph<N> implements Graph<N>, Mutable {

    public FixedSizeGraph(int size, int height, int limiter) {
        super(size, height, limiter);
    }
